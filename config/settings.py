...
# Static files storage with versioning (hash-based cache busting)
STORAGES = {
    "default": {
...
# Logging — StreamHandler writes to stderr; captured by systemd/journal without extra gunicorn flags.
